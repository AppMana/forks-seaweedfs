...
func (vl *VolumeLayout) UpdateVolumeSize(vid needle.VolumeId, reportedSize uint64, compactRevision uint32, fromHeartbeat bool) (recoveredToWritable bool) {
	vl.accessLock.Lock()
	defer vl.accessLock.Unlock()
	return vl.updateVolumeSizeLocked(vid, reportedSize, compactRevision, fromHeartbeat)
}
...
func (vl *VolumeLayout) UpdateVolumeSizeFromReplicas(vid needle.VolumeId) bool {
	...
	return vl.updateVolumeSizeLocked(vid, size, revision, true)
}

func (vl *VolumeLayout) updateVolumeSizeLocked(vid needle.VolumeId, reportedSize uint64, compactRevision uint32, fromHeartbeat bool) (recoveredToWritable bool) {
